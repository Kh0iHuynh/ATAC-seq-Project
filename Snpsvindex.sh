...
sort scg2.txt | uniq -c | awk '{print $2,$3,$4,$5,$6,$7,$8,$9}' | sort -k1,1 -k2,2n -k3,3n -k5,5 -k6,6 -k7,7n >> scg.txt
sort sci2.txt | uniq -c | awk '{print $2,$3,$4,$5,$6,$7,$8,$9}' | sort -k1,1 -k2,2n -k3,3n -k5,5 -k6,6 -k7,7n >> sci.txt
sort svcg2.txt | uniq -c | awk '{print $2,$3,$4,$5,$6,$7,$8,$9}' | sort -k1,1 -k2,2n -k3,3n -k5,5 -k6,6 -k7,7n > svcg.txt
sort svci2.txt | uniq -c | awk '{print $2,$3,$4,$5,$6,$7,$8,$9}' | sort -k1,1 -k2,2n -k3,3n -k5,5 -k6,6 -k7,7n > svci.txt

sort svli2.txt | uniq -c | awk '{print $2,$3,$4,$5,$6,$7,$8,$9}' | sort -k1,1 -k2,2n -k3,3n -k5,5 -k6,6 -k7,7n > svli.txt
sort svlg2.txt | uniq -c | awk '{print $2,$3,$4,$5,$6,$7,$8,$9}' | sort -k1,1 -k2,2n -k3,3n -k5,5 -k6,6 -k7,7n > svlg.txt
sort sli2.txt | uniq -c | awk '{print $2,$3,$4,$5,$6,$7,$8,$9}' | sort -k1,1 -k2,2n -k3,3n -k5,5 -k6,6 -k7,7n >> sli.txt
sort slg2.txt | uniq -c | awk '{print $2,$3,$4,$5,$6,$7,$8,$9}' | sort -k1,1 -k2,2n -k3,3n -k5,5 -k6,6 -k7,7n >> slg.txt
